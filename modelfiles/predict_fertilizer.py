...
# Configuration
MODEL_PATH = r"C:\codingalright\genailearning\housingagain\modelfiles\fertilizer_model.pkl"
ENCODERS_PATH = r"C:\codingalright\genailearning\housingagain\modelfiles\fertilizer_encoders.pkl"
...
def predict_fertilizer(temp, humidity, moisture, soil_type, crop_type, nitrogen, potassium, phosphorous):
    ...
    # 2. Build Input Frame (order must match training: Temparature, Humidity, Moisture, Soil Type, Crop Type, Nitrogen, Potassium, Phosphorous)
    # Note from training column names check earlier: ['Temparature', 'Humidity', 'Moisture', 'Soil Type', 'Crop Type', 'Nitrogen', 'Potassium', 'Phosphorous']
